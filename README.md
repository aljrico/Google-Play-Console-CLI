...
gpc subscription-offers create --package com.example.app --product-id premium_monthly --base-plan-id monthly --offer-id intro --free-region US --other-regions-free --targeting-acquisition-scope this-subscription --phase-duration P7D --regions-version 2026/05 --dry-run
gpc subscription-offers create --package com.example.app --product-id premium_monthly --base-plan-id monthly --offer-id upgrade-intro --free-region US --targeting-upgrade-scope specific-subscription-in-app --targeting-upgrade-product-id basic_monthly --targeting-upgrade-billing-period P1M --targeting-upgrade-once-per-user --phase-duration P7D --regions-version 2026/05 --dry-run
gpc subscription-offers create --package com.example.app --product-id premium_monthly --base-plan-id monthly --offer-id global-paid --price US:USD:1:990000000 --other-regions-usd-price USD:1:990000000 --other-regions-eur-price EUR:1:990000000 --phase-duration P1M --regions-version 2026/05 --dry-run
gpc subscription-offers create --package com.example.app --product-id premium_monthly --base-plan-id monthly --offer-id intro-paid --free-region US --phase-duration P7D --phase-2-price US:USD:1:990000000 --phase-2-duration P1M --phase-2-recurrence 2 --regions-version 2026/05 --dry-run
...
gpc subscription-offers create --package com.example.app --product-id premium_monthly --base-plan-id monthly --offer-id intro --absolute-discount US:USD:1:990000000 --phase-duration P1M --regions-version 2026/05 --dry-run
