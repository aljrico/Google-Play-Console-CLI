...
gpc subscription-offers create --package com.example.app --product-id premium_monthly --base-plan-id monthly --offer-id intro --free-region US --other-regions-free --phase-duration P7D --regions-version 2026/05 --dry-run
