...
GPC_NOTIFY_WEBHOOK_URL="$MATTERMOST_WEBHOOK_URL" gpc notify mattermost --title "Release" --message "Internal release staged" --field track=internal --dry-run
...
gpc subscription-offers create --package com.example.app --product-id premium_monthly --base-plan-id monthly --offer-id global-relative --relative-discount US:0.5 --other-regions-relative-discount 0.5 --phase-duration P1M --regions-version 2026/05 --dry-run
