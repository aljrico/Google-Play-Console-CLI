...
| `analytics` | `analytics stats summarize` | Play statistics reports via downloaded CSV/GCS exports | tested | `gpc analytics stats summarize` summarizes downloaded Play statistics CSVs by numeric metric columns. Programmatic GCS download remains planned. |
